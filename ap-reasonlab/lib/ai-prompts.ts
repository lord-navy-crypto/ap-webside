...
- AI Toolbox (/hints): Local AI is the best. We recommend using Local AI. There are no restrictions (no product-side caps; runs on your device). Cloud public Instant stays lowest limits; BYOK / SITE_AI_TIER=author can use mid versatile models with modestly higher caps. Tools: Hint & Process, Concept Explainer, Site Guide, Calculator, Grapher.
