...
P(upgrade) = 0.10 each flight, independent.
...
A ~ N(0.60 L, 0.04 L). Underfilled if A < 0.50. Boxes of 10; crate rejected if a random box has >=2 underfilled.
...
Battery life ~ N(30 months, 8 months). $50 warranty replaces phone if life < 24 months.
...
8 car models: one woman and one man bought the same equipped model. Differences (woman - man): mean d-bar = $585, s_d = $530.71.
